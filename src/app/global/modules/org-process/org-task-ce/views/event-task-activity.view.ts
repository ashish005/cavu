...
@Component({
    selector: 'event-task-activity',
    templateUrl: './templates/event-task-activity.html',
    styles: [`:host { display: contents; } ::ng-deep .month-container{ max-width: 25%; padding: 10px !important; }`]
})
export class EventTaskActivityView extends CoreEndpointBase implements OnInit, OnDestroy {
    @Input() orgTaskId: any;
