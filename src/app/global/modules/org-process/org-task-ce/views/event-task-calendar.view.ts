...
import {CoreSectorResourceService, CoreQueryOptions} from "../../../../core-setup";
...
@Injectable()
class OrgTaskCalendarService extends CoreSectorResourceService<OrgTaskCalendar>{
    constructor(public injector: Injector) { super(injector, 'taskCalendar', new OrgTaskCalendarSerializer()); }
}
@Component({
    selector: 'event-task-calendar',
    templateUrl: './templates/event-task-calendar.html',
    styles: [`:host{ display: contents; }`],
    providers: [OrgTaskCalendarService]
})
export class EventTaskCalendarView implements OnInit, OnDestroy {
