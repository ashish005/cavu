...
@Component({ standalone: false, selector: 'on-task-success-scheduler', templateUrl: './templates/on-task-success-scheduler.html' })
export class OnTaskSuccessSchedularComponent implements OnInit{
