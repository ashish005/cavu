export class DBkeys {
    ...
    public static readonly GLOBAL_FILTER = 'global_filter';

    public static readonly ORG_SESSION = 'org_sessionId';
    public static readonly ORG_BRANCH_ID = 'org_branchId';
    //public static readonly ORG_COUNTRY_ID = 'countryId';
