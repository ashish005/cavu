...
import {LocalStoreManager} from "./models/local-store-manager";
...
export class ConfigurationService {
    ...
    get language() { return this._language || ConfigurationService.defaultLanguage; }
    ...
    get themeId() { return this._themeId || ConfigurationService.defaultThemeId; }

    set uiSetting(value: OrgTheme) {
        this._uiSetting = value;
        this.saveToLocalStore(value, DBkeys.UI_SETTING);
        this.themeManager.applySetting(this._uiSetting);
    }
    get uiSetting() { return this._uiSetting; }

    set homeUrl(value: string) {
        this._homeUrl = value;
        this.saveToLocalStore(value, DBkeys.HOME_URL);
    }
    get homeUrl() { return this._homeUrl || ConfigurationService.defaultHomeUrl; }
    ...
    private _uiSetting: OrgTheme = null;
    ...
    private loadLocalChanges() {
        ...
        if (this.localStorage.exists(DBkeys.UI_SETTING)) {
            this._uiSetting = this.localStorage.getDataObject<OrgTheme>(DBkeys.UI_SETTING);
            this.themeManager.applySetting(this._uiSetting);
        }
    ...
    public import(jsonValue: string) {
        ...
        if (jsonValue) {
            const importValue: UserConfiguration = FuncHelper.JsonTryParse(jsonValue);
            ...
            if (importValue.uiSetting != null) {
                this.uiSetting = importValue.uiSetting;
            }
    ...
    public export(changesOnly = true): string {
        const exportValue: UserConfiguration = {
            ...
            uiSetting: changesOnly ? this._uiSetting : this.uiSetting,
            //countryId: changesOnly ? this._countryId : this.countryId,
    ...
    public clearLocalChanges() {
        ...
        this.localStorage.deleteData(DBkeys.UI_SETTING);
        this.resetLanguage(); //TODO - CHECK WHEN TO REFRESH
        this.resetTheme();
    }
    ...
    public resetUiSettings() {
        this._uiSetting = this.themeManager.defaultTheme;
        this.themeManager.applySetting(this._uiSetting);
    }
}
