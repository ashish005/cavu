...
import {VendorProduct, VendorProductSerializer} from "../domains/vendor-product.serializer";

@Injectable()
export class SupplierFacilityService extends OrgResourceService<VendorProduct>{
    constructor(public override injector: Injector) { super(injector, 'supplierProduct', new VendorProductSerializer()); }
