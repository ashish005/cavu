...
export class SupplierManageView extends ViewExtender<Vendor> implements OnInit{
  ...
  constructor(public override service: SupplierManagementService,
      ...
      this.gridOptions.columnDefs = [
          {headerName: 'grid.header.vendor_tax_ref', field: 'tradeName', cellTemplate: VendorNameActionCell },
          {headerName: 'grid.header.reg_date', field: 'registrationDate', cellTemplate: DateFormatCell  },
          ...
          {headerName: 'grid.header.amt_calc_type', field: 'amountCalcType' },
          {headerName: 'grid.header.cost_calc_type', field: 'costCalcType' },
          {headerName: 'grid.header.tax_item', field: 'hasTaxByItem', cellTemplate: GridUISwitchCellComponent },
          {headerName: 'grid.header.tax_inclusive', field: 'hasItemInclTax', cellTemplate: GridUISwitchCellComponent },
          {headerName: 'grid.header.disc_inclusive', field: 'hasItemInclDiscount', cellTemplate: GridUISwitchCellComponent },
