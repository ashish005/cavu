...
export class ProjectTaskQueryOptions extends CoreQueryOptions {
  projectId: string;
  accountId: string;
  customerId: string;
    moduleId: string;
...
export class ProjectTaskSerializer {
  fromJson(json: any): ProjectTask { return new ProjectTask(json); }
