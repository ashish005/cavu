...
@Component({
  standalone: false,
    ...
    templateUrl: './templates/variant-grid.html', styles: [`:host{ display: contents; }`]})
export class VariantGridComponent extends ViewExtender<ProductVariant> implements OnInit {
  override coreState: ProductVariantQueryOptions = new ProductVariantQueryOptions();
    ...
    constructor(public override activatedRoute: ActivatedRoute, public override service: ProductVariantService) {
