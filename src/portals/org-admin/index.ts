...
//         loadChildren: () => import('app-modules/admin-modules/org-process-management/index').then(m => m.ProcessModule),
...
//         loadChildren: () => import('app-modules/admin-modules/org-compliance-management/index').then(m => m.ComplianceModule),
