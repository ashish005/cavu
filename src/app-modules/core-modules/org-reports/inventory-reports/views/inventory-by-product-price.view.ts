...
import {
    ...
    InventoryProductPriceQueryOptions
} from "../domains/inventory-product.serializer";
import {InventoryByProductPriceService} from "../services/inventory.service";

@Component({
  standalone: false,
  templateUrl: './templates/inventory.html'
})
export class InventoryByProductPriceView extends ViewExtender<InventoryProductPrice> implements OnInit, OnDestroy {
  @ViewChild('dateForm', { read: ViewContainerRef, static: true }) dateForm;
  override coreState: InventoryProductPriceQueryOptions = new InventoryProductPriceQueryOptions();
  constructor(public override service: InventoryByProductPriceService,
