...
export class ExpenseQueryOptions extends CoreQueryOptions{
  searchAction: string;
...
export class Voucher {
    ...
    constructor(model: any = <any>{}){
        ...
        this.voucherMasterType = voucherMasterType || 'SALE';
...
export class FinanceVoucher extends CoreResource {
    ...
    constructor(model: any = <any>{}){
        super();
        const { voucher, items, billToBillTrxn, sundryDetails, trxnInfo } = model;
...
export class Expense extends FinanceVoucher {
    //netAmount: number;
    constructor(model: any = <any>{}){
        super(model);
        //this.netAmount = model.voucher.amount;
    }
}
