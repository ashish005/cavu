...
import {DayBook, DayBookSerializer} from "../domains/book/day-book.serializer";
import {CashBook, CashBookSerializer} from "../domains/book/cash-book.serializer";
import {BankLedger, BankLedgerSerializer} from "../domains/book/bank-ledger.serializer";
import {LedgerBook, LedgerBookSerializer} from "../domains/book/ledger-book.serializer";
import {
    LedgerGroupSummary,
    LedgerGroupSummarySerializer
} from "../domains/book/trial-balance/ledger-group-summary.serializer";
import {TrialBalance, TrialBalanceSerializer} from "../domains/book/trial-balance/trial-balance.serializer";
import {
    LedgerReportMonthly,
