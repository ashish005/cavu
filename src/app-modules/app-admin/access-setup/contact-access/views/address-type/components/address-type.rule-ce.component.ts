...
import {AddressTypeRuleForm} from "../form/address-type-rule.form";
...
export class AddressTypeRuleCeComponent extends AddressTypeRuleForm {
  ...
  constructor(public override fb: FormBuilder, public service: AddressTypeService) {
    super(fb);
  }
