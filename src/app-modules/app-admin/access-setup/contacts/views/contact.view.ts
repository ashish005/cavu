...
import {GridUISwitchCellComponent, ORG_USER_TYPE, ViewExtender} from "@app-global";
@Component({
  templateUrl: './templates/contact.html',
  styles: [`:host { display: contents;}`]
})
export class ContactView extends ViewExtender<Contact> implements OnInit
{
  ...
  ngOnInit(){
      this.activatedRoute.params.subscribe((params: Params) => {
          ...
          this.coreState.contactType = contactType || ORG_USER_TYPE.EMPLOYEE;
