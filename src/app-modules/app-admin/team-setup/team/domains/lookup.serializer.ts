/*
import {CoreResource, CoreSerializer} from "@app-global";
...
export class TeamSetupLookup extends CoreResource {
    ...
    getFilterByUserType(userTypeId: number){

    }
}

export class TeamSetupLookupSerializer {
    fromJson(json: any): TeamSetupLookup { return new TeamSetupLookup(json); }
