import { CoreResource, FuncHelper } from "@app-global";
...
export class NotificationLookup extends CoreResource{
    ...
    allNotificationTypes: Array<NotificationTypeLookup>;
    constructor(model: any = <any>{}){
        super();
        ...
        this.allNotificationTypes = FuncHelper.flatTreeStructure(this.notificationTypes);
    }

    getNotificationTypeLookups=()=> (this.allNotificationTypes || []).filter(r =>  !r.isSystem);

    getNotificationTypeByUserType=(userMasterType: string)=> this.allNotificationTypes.find(r => r.userMasterType == userMasterType);
    ...
    getMediaTypeByMaster(masterMediaType: any){
        return this.mediaTypes.find(r => r.masterType == masterMediaType);
    }
