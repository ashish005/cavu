...
export class NotificationReminderQueryOptions extends CoreQueryOptions {
    orgUserId: string;
...
export class NotificationReminderTemplate {
    id: number | string;
...
export class NotificationReminder extends CoreResource {
    ...
    templates: Array<NotificationReminderTemplate>;
    constructor(model: any = <any>{}) {
        super();
        const {
        ...
        this.templates = (templates || []).map(r => new NotificationReminderTemplate(r));
    }
}

export class NotificationReminderSerializer {
    fromJson(json: any): NotificationReminder { return new NotificationReminder(json); }
