...
export class Scheduler extends CoreResource {
    ...
    startTimeZoneDate: string;
    endTimeZoneDate: string;
    nextDueDate: string;
    ...
    constructor(model: any = <any>{}){
        ...
        const {
            ...
            frequencyTypeId, orgTaskId, isManual,
            frequencyTypeName, taskName, taskPriorityName, processName,

            lastSuccessRun, lastRun, nextRun, todayRun,
            nextDueDate, startTimeZoneDate, endTimeZoneDate,
            status, isLocked
        } = model || {};
        this.id = id;
        this.name = name;
        ...
        this.endTimeZoneDate = endTimeZoneDate;
