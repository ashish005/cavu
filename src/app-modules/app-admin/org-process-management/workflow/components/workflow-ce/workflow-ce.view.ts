...
import {OrgWorkflow} from "../../domains/org-workflow.serializer";
import {WorkflowService} from "../../services/workflow.service";

class OrgWorkflowForm {
  ...
  populateOrgProcess(item: OrgWorkflow){
...
@Component({
  standalone: false,
  templateUrl: './workflow-ce.html',
  styleUrl: `./workflow.css`
})
export class WorkflowCeView extends OrgWorkflowForm implements OnInit, OnDestroy {
  ...
  constructor(public override fb: FormBuilder, private service: WorkflowService) { super(fb); }
  ngOnInit(){
    if(this.id) {
      this.isLoading = true;
