import {
    ...
    Component,
    ElementRef,
    EventEmitter, Injectable, Injector, Input, OnDestroy,
    OnInit,
    Output,
    ViewChild
} from "@angular/core";
...
import {ASIDE_CLASS, ASIDE_SIZE, CoreEndpointBase, DateHelper, OrgResourceService, SharedService} from "@app-global";

@Injectable()
class AccountingBookAPIResolver extends CoreEndpointBase {
...
@Component({
  ...
  templateUrl: './templates/book-search.html',
    providers: [AccountingBookAPIResolver],
  styles: [`
     input#search {
          color: inherit;
          padding: unset;
...
export class BookSearchComponent implements OnInit, AfterViewInit, OnDestroy{
    ...
    constructor(public fb: FormBuilder, private service: AccountingBookAPIResolver) {
