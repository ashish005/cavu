...
export class LedgerBookQueryOptions extends CoreQueryOptions{
    accountId: string;
    startDate: string;
    endDate: string;
...
export class LedgerBook extends CoreResource{
  head: string;
  extraInfo: string;
  trxnDate: Date;
  credit: string;
...
export class LedgerBookSerializer{
    fromDataJson(json: BookSummaryData): BookSummaryData { return new BookSummaryData(json); }
  fromJson(json: LedgerBook): LedgerBook { return new LedgerBook(json); }
